...
>(function HomeEsperienzaSection({ media }, ref) {
  ...
  return (
    <section
      ...
      className="relative z-10 -mt-[100svh] scroll-mt-[5.5rem] overflow-hidden rounded-t-3xl border-t border-fc-soft/40 bg-fc-white shadow-[0_-16px_48px_rgba(36,76,144,0.07)]"
    >
